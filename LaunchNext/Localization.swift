...
final class LocalizationManager {
    ...
    private init() {
        ...
        builder[.french]?.merge([
            ...
            .gameControllerPlaceholderSubtitle: "Branchez une manette et utilisez la croix directionnelle pour parcourir les apps. Des réglages arrivent bientôt.",
            ...
            .gameControllerStatusNoController: "Aucune manette détectée pour le moment.",
            ...
            .gameControllerQuickGuideCancel: "Le bouton B (ou Menu) ferme Launchpad.",
            .soundToggleTitle: "Activer les effets sonores",
            .soundToggleDescription: "Utiliser les sons système macOS pour les actions LaunchNext.",
            .soundEventLaunchpadOpen: "Ouverture de Launchpad",
            .soundEventLaunchpadClose: "Fermeture de Launchpad",
            .soundEventNavigation: "Déplacement du focus",
            .soundPreviewButton: "Préécouter",
            .soundOptionNone: "Aucun",
            .voiceToggleTitle: "Activer Voice Over",
            .voiceToggleDescription: "Voice Over annonce le nom de l’app sélectionnée lors de la navigation au clavier ou à la manette.",
            .voiceNoteMutualExclusive: "Voice Over remplace le son de navigation par une annonce vocale.",
            .voiceAnnouncementAppFormat: "%@",
