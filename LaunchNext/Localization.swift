...
final class LocalizationManager {
    ...
    private init() {
        ...
        builder[.italian]?.merge([
            ...
            .customTitleHint: "Rinomina le app qui. I titoli personalizzati persistono attraverso importazioni e cambi di localizzazione.",
            .customTitleDefaultFormat: "Predefinito: %@",
            .customTitleReset: "Ripristina predefinito",
            .customTitleAddButton: "Aggiungi applicazione",
            .customTitleEmptyTitle: "Nessun titolo personalizzato",
            ...
            .customTitlePickerMessage: "Seleziona un'applicazione per gestire il suo titolo.",
            ...
            .customIconHint: "File PNG/ICNS a 512×512 funzionano meglio. Le modifiche si applicano istantaneamente.",
            ...
            .showFPSOverlayDisclaimer: "Misurazione approssimativa; potrebbe non riflettere il pacing effettivo dei frame."
        ]) { _, new in new }
